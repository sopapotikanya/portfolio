...
% mex -largeArrayDims -DWIN -output  svm_struct_learn svm_struct_learn_mex.c svm_struct_api.o  svm_struct_learn_custom.o svm_struct_learn.o svm_struct_common.o svm_common.o svm_learn.o svm_hideo.o
delete *.obj
